...
Terminals: race-confirmed 12, races-unclassified 13, race@interp 7, proved@T0 7, proved@T1 8, proved@T1+assumes-termination 4, proved@interp 5 (one carrying the §3n content-fragile attribute). Companion micro-suites: golden_smoke 7 (3 race-confirmed / 4 proofs), rmw_sync 9, await_sync 9 (3 conditional proofs + 6 detected races).
