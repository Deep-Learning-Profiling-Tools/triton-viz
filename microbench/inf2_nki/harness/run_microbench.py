...
from microbench.inf2_nki.tests.engine_ops.kernels import (
    ...
    tensor_matmul_small_work_units,
    tensor_matmul_transpose_pipeline_factory,
    tensor_matmul_transpose_pipeline_work_units,
    tensor_attention_pipeline_factory,
    tensor_attention_pipeline_work_units,
...
BENCHMARKS = {
    ...
    "tensor_matmul_small": {
        "folder": "engine_ops",
        "factory": tensor_matmul_small_factory,
        "work": tensor_matmul_small_work_units,
        "input": "default",
    },
    "tensor_matmul_transpose_pipeline": {
        "folder": "engine_ops",
        "factory": tensor_matmul_transpose_pipeline_factory,
        "work": tensor_matmul_transpose_pipeline_work_units,
        "input": "default",
    },
    "tensor_attention_pipeline": {
        "folder": "engine_ops",
        "factory": tensor_attention_pipeline_factory,
        "work": tensor_attention_pipeline_work_units,
        "input": "default",
    },
