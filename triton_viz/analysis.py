...
def analyzer():
    ...
    tensor_ptr_to_element_size = {tensor.ptr: tensor.element_size for tensor in launch_data.tensors}
    ...
    overall_load_ratio = total_load_bytes_true / total_load_bytes_attempted if total_load_bytes_attempted > 0 else 0
    overall_store_ratio = total_store_bytes_true / total_store_bytes_attempted if total_store_bytes_attempted > 0 else 0
